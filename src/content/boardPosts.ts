...
export const FALLBACK_BOARD_POSTS: BoardPost[] = [
  ...
  },
  {
    ...
    body:
      'The Sweetardio Collection mint is scheduled for September 14, 2026 at 16:15 UTC. Join the whitelist, then mint here on Sweetardio.fun or use LaunchMyNFT directly.',
    tag: 'Mint',
    link: '#/mint',
