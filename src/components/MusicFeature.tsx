...
const MusicFeature = () => (
  <section id="music" className="relative mx-auto max-w-5xl px-6 py-20 sm:py-24">
    <div className="sw-reveal relative bg-gradient-to-br from-sweetardios-cyan/45 via-sweetardios-violet/25 to-sweetardios-cerise/45 p-px shadow-[0_40px_120px_-40px_rgba(52,237,243,0.55)]">
      <div className="relative grid grid-cols-1 items-center gap-10 overflow-hidden bg-sweetardios-oxford/85 px-8 py-12 backdrop-blur-2xl sm:px-12 sm:py-14 md:grid-cols-2">
        ...
        <div className="text-center md:text-left">
          ...
          <h2 className="font-heading text-4xl text-white sm:text-5xl">
            <span className="sw-sign"><span className="sw-glow-cyan text-sweetardios-cyan">Sounds</span> of Sweetardio</span>
          </h2>
